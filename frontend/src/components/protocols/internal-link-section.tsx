...
type ProtocolInternalLinkSectionProps = {
  title: string;
  links: InternalLink[];
};

/** Crawl-oriented internal link block for protocol review pages. */
export function ProtocolInternalLinkSection({
  title,
  links,
}: ProtocolInternalLinkSectionProps) {
